...
<template>
  <section class="container mx-auto flex items-center flex-col">
    ...
    <div
      class="p-10 bg-gradient-to-br from-pink-50 to-indigo-100 grid place-items-center"
    >
